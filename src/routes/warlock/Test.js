...
if (Module['locateFile']) {
  ...
  wasmBinaryFile = new URL('Test.wasm', import.meta.url).href;
}
...
// include: /opt/homebrew/Cellar/emscripten/3.1.45/libexec/src/emrun_postjs.js
/**
 * @license
 * Copyright 2013 The Emscripten Authors
 * SPDX-License-Identifier: MIT
...
// end include: /opt/homebrew/Cellar/emscripten/3.1.45/libexec/src/emrun_postjs.js
